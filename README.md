...
Soy **Desarrollador Full Stack** y estudiante de **Ingeniería en Sistemas (UMG, 2026)**. Me enfoco en construir aplicaciones modernas con **React y Node.js**, cuidando el detalle visual, el rendimiento y un **código limpio y mantenible**.

Me interesan especialmente la **ciberseguridad**, el diseño **UI/UX** y la **inteligencia artificial**, buscando siempre mejorar la experiencia del usuario y la calidad de las soluciones que desarrollo.
